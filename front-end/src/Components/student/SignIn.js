      ...
      axios
        ...
        .catch(err => {
          ...
          store.addNotification({
            title: "Incorrect Email/password or You haven't been Approved from Admin",
            message: "try again",
            type: "danger",
            insert: "top",
            container: "top-right",
      ...
      return (
        <div className="signIn" >
          ...
          <div className="signInComponentContainer " >
            <ReactNotification />
            <div className="signInContainer" style={{width:430}}>
              ...
              <Link to="/student/Guest" className="signInForget signInA">
                  For Guests
              </Link>       
